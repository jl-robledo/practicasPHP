...
<body>
	...
	<main>
        <h1 class="formulario__grupo">Insertar Revista Nuevo</h1>
            ...
            <form action=" " class="formulario" name="registro_producto" method="post" enctype="multipart/form-data">
                ...
                <!-- extra -->
                <div class="formulario__grupo">
                    <label for="extra" class="formulario__label"><b>Contenido Extra</b></label>
                    <div class="formulario__grupo-input">
                        <input type="text" class="formulario__input" placeholder="Contenido Extra" name="extra" id="extra">
                    </div>
                </div>
