        ...
        <div class="mostrar__producto">
            <table class="mostrar__producto-tabla">
                ...
                <tbody>
                    ...
                    $query = "SELECT * FROM readingmaterial INNER JOIN book on readingmaterial.Id = book.Id_Rm";
                    ...
                    ?>
                        <tr>
                            <td><?php echo "<b>Titulo:  " . $fila['Titulo'] . 
                                            "</b><br>Autor:  " . $fila['Autor'] .
                                            "<br>Referencia:  " . $fila['Id'] . 
                                            "<br>Paginas:  " . $fila['Paginas'] . 
                                            "<br>Capitulos:  " . $fila['Capitulos']. 
